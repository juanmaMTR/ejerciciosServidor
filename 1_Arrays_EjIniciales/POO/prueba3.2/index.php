<!DOCTYPE html>
<!-- Llamamos a los métodos crear_array desde el archivo externo y desde este mismo archivo mostramos el array (NO usamos el método visualizar) -->
<html lang="es">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <?php
            ...
            /* Instancio el objeto */
            $modelo=new Modelo;
            /* Instancio las variables que retorno del método darValores() */
            //print_r ($modelo->darValores());
            $meses=$modelo->darValores()[0];
            $diasemana=$modelo->darValores()[1];
